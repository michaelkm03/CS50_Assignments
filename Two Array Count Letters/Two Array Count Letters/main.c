...
Your program should parse the string and keep track of number of alphabet. Both arrays are indexed from 0 to 25. The
logical way to do this is to use upper[0] to count the number of ‘A’, and upper[1] to count number of ‘B’ and so on.
